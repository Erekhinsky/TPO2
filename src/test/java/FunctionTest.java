...
//        log3Mock = Mockito.mock(Log.class);
//        log5Mock = Mockito.mock(Log.class);
//        log10Mock = Mockito.mock(Log.class);
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/in/function.csv")
    void testTanCot(double value, double expected) {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/in/function.csv")
    void testSecCsc(double value, double expected) {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/in/function.csv")
    void testSinTanSec(double value, double expected) {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/in/function.csv")
    void testCosCotCsc(double value, double expected) {
